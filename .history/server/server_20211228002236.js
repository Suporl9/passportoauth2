...
passport.serializeUser((user, done) => {
  ...
  done(null, user._id); //from the database since we are passing currently made user or existing  user from database //the user.id is passed here and after this deserializeuser is run
});
