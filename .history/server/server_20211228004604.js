...
passport.serializeUser((user, done) => {
  ...
  done(null, user); //from the database since we are passing currently made user or existing  user from database //safe practise to store only the id in session //the user.id is passed here and after this deserializeuser is run
});
